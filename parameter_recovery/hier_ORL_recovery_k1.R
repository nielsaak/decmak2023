...
for (i in 1:niterations) {
  ...
  params<-c("mu_a_rew",
            "mu_theta","mu_omega_f","mu_omega_p",
            "lambda_a_rew","lambda_theta",
            "lambda_omega_f","lambda_omega_p")
  samples <- jags.parallel(data, inits=NULL, params,
                           model.file ="hier_ORL_k1.txt", n.chains=3, 
...
#load("hier_ORL_recovery_k1.RData")
...
save.image(file = "hier_ORL_recovery_k1.RData")
